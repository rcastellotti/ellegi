...
int inspect_index(int argc, char **argv)
{
    ...
    content_chunk_header *chdrs = reinterpret_cast<content_chunk_header *>(map + idx->content_off);
    ...
    chunk_header *chunks = reinterpret_cast<chunk_header *>(map + idx->chunks_off);
